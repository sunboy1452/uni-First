...
<template>
  <view
    class="fui-digital__keyboard-wrap"
    :class="{
      'fui-digital__keyboard__ani': show,
      'fui-dk__theme-light': theme === 'light',
      'fui-dk__theme-dark': theme === 'dark',
      'fui-dk__safe-weex': iphoneX && safeArea,
    }"
    :style="{ zIndex: zIndex }"
    ref="fui_dk_ani"
  >
    ...
    <view class="fui-digital__keyboard-grids">
      <view class="fui-digital__keyboard-left">
        <view
          class="fui-dk__left-wrap"
          v-for="(item, index) in items"
          :key="item.id"
        >
          <view
            class="fui-dk__grid-left"
          ...
          >
            <text
              ...
              :class="{
                'fui-dk__key-dark': theme === 'dark',
                'fui-dk__highlight-dark': theme === 'dark' && val,
                'fui-dk__highlight': theme === 'light' && val,
              }"
      ...
      <view class="fui-digital__keyboard-right">
        <view class="fui-dk__grid-right">
          <view
            class="fui-digital__keyboard-key fui-dk__highlight"
            :class="{
              'fui-dk__key-dark': theme === 'dark',
              'fui-dk__highlight-dark': theme === 'dark',
            }"
            @tap.stop="backspace"
          >
            <fui-icon
        ...
        <view class="fui-dk__button-wrap">
          <view
            class="fui-dk__button"
            :class="{
              'fui-dk__button-color': !getBgColor,
              'fui-dk__btn-disabled': disabled,
            }"
            :style="{ background: getBgColor }"
          >
            <text
              class="fui-dk__button-text"
              :style="{
                color: color,
                fontSize: size + 'rpx',
            ...
            >
            <view
              class="fui-dk__button-ck"
              :class="{ 'fui-dk__highlight': !disabled }"
              @tap.stop="confirm"
            >
            </view>
          </view>
