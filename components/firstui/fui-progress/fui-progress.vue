  ...
  <view class="fui-progress__wrap">
    ...
    >
      ...
      <view
        ...
        :class="{ 'fui-progress__active-color': !activeColor }"
        :style="{
...
export default {
  ...
  methods: {
    ...
    darwProgress() {
      ...
      this.time =
        (Number(this.duration) * Math.abs(percent - this.percentage)) / 1000;
