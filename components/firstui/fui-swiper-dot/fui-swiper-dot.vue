  ...
  <view class="fui-swiper__wrap">
    ...
    >
      <view
        ...
        class="fui-swiper__dot-item"
        :class="{
          'fui-swiper__dot-bg': !dots.activeBackground && index == current,
        }"
        :style="{
          ...
          borderRadius: radius,
          background:
            index == current ? dots.activeBackground : dots.background,
    ...
    >
      <text
        @tap.stop="itemClick(index)"
        class="fui-swiper__dot-item fui-swiper__flex-center"
        :class="{
          'fui-swiper__dot-bg': !dots.activeBackground && index == current,
        }"
        :style="{
    ...
    >
      <text
        ...
        class="fui-swiper__dot-item fui-swiper__nav-ellipsis"
    ...
    <view
      v-if="type == 4"
      class="fui-swiper__dot"
      :style="{ right: dots.right + 'rpx', bottom: dots.bottom + 'rpx' }"
    >
      <text
        @tap.stop="itemClick(current)"
        class="fui-swiper__dot-item fui-swiper__flex-center"
