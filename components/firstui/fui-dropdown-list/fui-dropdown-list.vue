...
<template>
  <view
    class="fui-dropdown__list-wrap"
    :class="{ 'fui-dropdown__list-show': isShow }"
  ...
  >
    <view
      ...
      :style="{ borderRadius: radius + 'rpx', background: background }"
    >
      <scroll-view
      ...
      >
        ...
        <view>
          ...
          <view
            ...
            :class="{
              'fui-ddl__reverse': isReverse,
              'fui-ddl__item-line': splitLine && itemList.length - 1 !== index,
            }"
          ...
          >
            ...
            <view class="fui-ddl__flex">
              <view
                class="fui-ddl__icon-box"
                :class="{
                  'fui-ddl__icon-ml': !isReverse && isCheckbox,
                  'fui-ddl__icon-mr': isReverse,
                }"
              ...
              <text
                class="fui-ddl__item-text"
                :class="{
                  'fui-ddl__text-pl': !isReverse && (isCheckbox || model.src),
                  'fui-ddl__text-pr': isReverse && (isCheckbox || model.src),
                }"
                :style="{
                  fontSize: size + 'rpx',
