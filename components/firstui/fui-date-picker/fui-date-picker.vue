  ...
  <view class="fui-date__picker-wrap" @touchend="stop">
    ...
    >
      <view
        ...
        :class="{
          'fui-dpk__header-dark': theme === 'dark',
          'fui-date__picker-radius': radius,
        }"
        :style="headerStyl"
      >
      ...
      <view class="fui-dpk__range-wrap" v-if="range">
        <view
          ...
          :class="[
            theme === 'dark' ? 'fui-dpk__range-dark' : 'fui-dpk__range-light',
          ]"
        >
          <text
      ...
      <view @touchstart.stop="pickerstart">
        ...
        <picker-view
          ...
          :indicator-class="
            theme === 'dark' ? 'fui-date__picker-indicator' : ''
          "
        ...
        >
          ...
          <picker-view-column
            v-if="type == 4 || type == 5 || type == 6 || type == 7"
          >
            <text
              :style="contentStyl"
              v-for="(item, index) in hours"
          ...
          <picker-view-column
            v-if="type == 5 || type == 6 || type == 7 || type == 8"
          >
            <text
              :style="contentStyl"
              v-for="(item, index) in minutes"
