...
<template>
  <view
    class="fui-segmented__control"
    :class="{ 'fui-segmented__disabled': disabled }"
    :style="{
  ...
  >
    <view
      ...
      :style="{
        ...
        borderTopRightRadius:
          index === values.length - 1 ? radius + 'rpx' : '0',
        borderBottomRightRadius:
          index === values.length - 1 ? radius + 'rpx' : '0',
        borderColor: type === 'button' ? getColor : 'transparent',
        background:
          currentIndex === index && type === 'button'
            ? getColor
            : 'transparent',
        height: height + 'rpx',
      }"
      :class="{
        ...
        'fui-seg__item-bg':
          currentIndex === index && !color && type === 'button',
        'fui-seg__item-border': !color && type === 'button',
        'fui-segmented__item-border': type === 'button',
      }"
    ...
    >
      <text
        ...
        :class="{
          'fui-segmented__disabled': item.disabled,
          'fui-seg__text-color': !color && currentIndex !== index,
        }"
        >{{ item.name }}</text
      >
      <view
