...
EAN13 = (function () {
    ...
    EAN13.prototype.getCode = function () {
        ...
        code = "";
        c_encoding =
            countries[parseInt(this.number.substr(0, 1), 10)].split("");
    ...
    EAN13.prototype.draw = function (code) {
        ...
        if (this.settings.number) {
            border_height =
                layout.border_line_height_number * this.settings.height;
        ...
        if (this.ctx) {
            ...
            if (this.settings.debug) {
                for (
                    x = _i = 0, _ref = item_width * 2;
                    _ref > 0 ? _i <= width : _i >= width;
                    x = _i += _ref
                ) {
                    context.beginPath();
