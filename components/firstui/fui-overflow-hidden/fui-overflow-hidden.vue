...
<template>
  <view
    class="fui-overflow__hidden-wrap"
    :class="{
      'fui-overflow__hidden': type == 1,
      'fui-gradient__hidden': type == 2 && !visible,
      'fui-text__nowrap': type == 1 && rows == 1,
    }"
    :style="{
      width: width,
  ...
  >
    ...
    <slot></slot>
    <view
      class="fui-oh__gradient-wrap"
      :style="{ background: getGradientBgColor }"
      v-if="type == 2 && !visible"
    ></view>
  </view>
</template>
