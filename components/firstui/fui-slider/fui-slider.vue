...
<template>
  <view class="fui-slider__wrap-outer">
    <text
      class="fui-slider__value"
      :class="['fui-slider__vr']"
      :style="{
        width: valueWidth + 'px',
        color: valueColor,
    ...
    >
      ...
      >
        <view
          class="fui-slider__pole-left"
          :class="{ 'fui-slider__pole-bg': !getActiveColor }"
          :style="{ background: getActiveColor }"
        ></view>
        <view
          class="fui-slider__pole-right"
          :class="{ 'fui-slider__pole-bg': !getActiveColor }"
          :style="{ background: getActiveColor }"
        ></view>
      </view>
      <view
        class="fui-slider__handle"
        :style="{
          width: blockWidth + 'px',
    ...
    >
      ...
      >
        <view
          class="fui-slider__pole-left"
          :class="['fui-slider__pole-r']"
          ref="poleLeft"
          :style="{ background: getActiveColor }"
        ></view>
        <view
          class="fui-slider__pole-right"
          :class="['fui-slider__pole-l']"
          ref="poleRight"
          :style="{ background: getActiveColor }"
        ></view>
      </view>
      <view
        ...
        :class="[
          'fui-slider__handle-left',
          isAndroid ? 'fui-slider__border' : 'fui-slider__shadow',
        ]"
      ></view>
      <view
        class="fui-slider__handle"
    ...
    >
      ...
      >
        <view
          ...
          :class="[
            'fui-slider__pole-r',
            getActiveColor ? '' : 'fui-slider__pole-bg',
          ]"
      ...
      <view
        ...
        :class="['fui-slider__handle-right']"
        @touchstart="endTouchstart"
