...
<template>
  <view
    class="fui-countdown__verify"
    :class="{ 'fui-cdv__disabled': status > 1 }"
    :style="{
      width: width + 'rpx',
      height: height + 'rpx',
      ...
      borderColor:
        !getBorderColor || getBorderColor === true
          ? background
          : getBorderColor,
    }"
  >
    <text
      ...
      class="fui-countdown__verify-text"
      :class="{ 'fui-cdv__color': !getColor }"
      >{{ showText }}</text
    >
    <view
      class="fui-countdown__verify-main fui-countdown__verify-active"
    ...
    <!-- #ifndef APP-NVUE -->
    <view
      class="fui-countdown__verify-line"
      :class="{ 'fui-cdv__border-color': !getBorderColor }"
