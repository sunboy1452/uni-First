...
<template>
  <view
    class="fui-search__bar-wrap"
    :class="{ 'fui-searchbar__wrap-bg': !background }"
    :style="{
  ...
  >
    ...
    <view class="fui-search__bar-form" :style="{ height: height + 'rpx' }">
      <view
        class="fui-search__bar-box"
        :class="{
          'fui-searchbar__focus-invalid':
            !isFocus && !isSearch && showLabel && !disabled,
        }"
        :style="{
          height: height + 'rpx',
      ...
      >
        ...
        <input
          ref="searchBarRef"
          class="fui-search__bar-input"
          :class="{ 'fui-sb__input-color': !color }"
          :style="{ color: color, height: height + 'rpx' }"
          placeholder-class="fui-search__bar-pl"
      ...
      <view
        class="fui-search__bar-label"
        :class="[isLeft ? 'fui-sb__label-left' : 'fui-sb__label-center']"
    ...
    <text
      ...
      class="fui-search__bar-btn"
      :class="{ 'fui-sb__btn-color': !searchColor }"
