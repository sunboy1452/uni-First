...
export default class CanvasRenderingContext2D {
    ...
    set fillStyle(value) {
        ...
        if (typeof value == "string") {
            ...
            for (var i = 0; i < value._stop_count; ++i) {
                command +=
                    "," + value._stops[i]._pos + "," + value._stops[i]._color;
            }
    ...
    moveTo(x, y) {
        this._drawCommands = this._drawCommands.concat(
            "g" + x.toFixed(2) + "," + y.toFixed(2) + ";"
        );
    }

    lineTo(x, y) {
        this._drawCommands = this._drawCommands.concat(
            "i" + x.toFixed(2) + "," + y.toFixed(2) + ";"
        );
    }
    ...
    measureText(text) {
        return CanvasRenderingContext2D.GBridge.measureText(
            text,
            this.font,
            this.componentId
        );
    ...
    _flush(reserve, callback) {
        ...
        this._drawCommands = "";
        CanvasRenderingContext2D.GBridge.render2d(
            this.componentId,
            commands,
            callback
        );
    ...
    draw(reserve, callback) {
        if (!reserve) {
            ...
            this._needRedrawImageCache = this._needRedrawImageCache.concat(
    ...
    getImageData(x, y, w, h, callback) {
        CanvasRenderingContext2D.GBridge.getImageData(
            this.componentId,
            x,
            y,
            w,
    ...
    putImageData(data, x, y, w, h, callback) {
        if (data instanceof Uint8ClampedArray) {
            ...
            CanvasRenderingContext2D.GBridge.putImageData(
                this.componentId,
                data,
                x,
                y,
