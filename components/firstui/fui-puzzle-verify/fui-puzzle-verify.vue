...
<template>
  ...
  >
    ...
    >
      <text
        class="fui-sc__title"
        :style="{ width: width + 'px', color: color, fontSize: size + 'rpx' }"
        >{{ title }}</text
      >
      <text
        class="fui-sc__descr"
      ...
      <view class="fui-sc__img-box" :style="{ width: width + 'px' }">
        ...
        >
          <image
            ...
            :class="{ 'fui-sc__img-border': isNvueAndroid }"
          >
          </image>
        </view>
        <!-- #endif -->
        ...
        <view
          class="fui-sc__slot-box"
          :class="{ 'fui-sc__sb-bs': true, 'fui-sc__reset-ani': resetAni }"
      ...
      <view
        ...
        :style="{ width: width + 'px', height: sliderH + 'px' }"
      >
        <view
          class="fui-sc__bar"
          :style="{
        ...
        <view
          ...
          :class="{ 'fui-sc__slider-bg': !sliderBgColor }"
          :style="{
            width: sliderH * 2 + 'px',
            height: sliderH + 'px',
            borderRadius: sliderH + 'px',
        ...
        <view
          class="fui-sc__slider"
          :class="{
            'fui-sc__slider-bg': !sliderBgColor,
