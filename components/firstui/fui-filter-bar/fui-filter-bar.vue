...
<template>
  <view
    class="fui-filter__bar-wrap"
    :style="{ height: height + 'rpx', background: background }"
  >
    <view
      class="fui-filter__bar-item"
    ...
    >
      <text
        class="fui-filter__bar-text"
        :class="{ 'fui-fb__text-hidden': item.text.length > 4 }"
        :style="{
          fontSize: size + 'rpx',
          lineHeight: size + 'rpx',
