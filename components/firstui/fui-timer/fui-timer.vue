...
export default {
  ...
  methods: {
    ...
    _aniEnd() {
      ...
      animation.transition(this.$refs["fui_timer_ms"].ref, {
        styles: {
    ...
    timer(seconds) {
      ...
      if (seconds > 0) {
        ...
        minute = this.isMinutes
          ? Math.floor(seconds / 60) - hour * 60 - day * 24 * 60
          : 0;
        second = this.isSeconds
          ? Math.floor(seconds) -
            day * 24 * 60 * 60 -
            hour * 60 * 60 -
            minute * 60
