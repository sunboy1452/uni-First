<template>
	<div>
		...
		<div ref="picker" class="picker-pop" @touchmove.prevent.stop>
			...
			<div class="picker-panel" :class="{'picker-panel-translate': show}">
				...
				<div class="picker-content">
					<div v-for="(column, columnIndex) in columns" class="picker-column"
						:style="pickerStyle.column[columnIndex]" :data-column="columnIndex" @touchstart="touchstart"
						@touchmove="touchmove">
						<div class="scroll-wrapper">
							...
							<view class="scroll-list" :animation="column.animationData">
								<div v-for="(data, itemIndex) in column.pickerList">
									<div class="picker-item" <!-- #ifdef H5-->
	...
	export default {
		...
		methods: {
			...
			setColumn(columnIndex, pickerList) {
				...
				column.pickedIndex = Math.min(currentColumn.pickedIndex, column.pickerList.length - 1) ||
