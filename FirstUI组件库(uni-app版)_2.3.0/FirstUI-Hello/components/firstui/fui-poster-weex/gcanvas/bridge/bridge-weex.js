...
const logCommand = (function () {
    ...
    const logCommand = (id, cmds) => {
        ...
        console.log(
            `=== callNative - componentId:${id}; method: ${mName}; cmds: ${cmds}`
        );
    };
    return logCommand;
})();
...
const GBridge = {
    ...
    callReset: function (id) {
        GCanvasModule.resetComponent &&
            canvasModule.resetComponent(componentId);
    },
    ...
    render2d: isWeexIOS
        ? function (componentId, commands, callback) {
              ...
              GCanvasModule.render(
                  [commands, callback ? true : false],
                  componentId,
                  callback
              );
          }
    ...
    flushNative: isWeexIOS
        ...
        : function (componentId) {
              ...
              const result = callGCanvasLinkNative(
                  componentId,
                  0x60000000,
                  cmdArgs
              );
    ...
    texImage2D(componentId, ...args) {
        if (isWeexIOS) {
            if (args.length === 6) {
                const [target, level, internalformat, format, type, image] =
                    args;
                GBridge.callNative(
                    componentId,
                    GLmethod.texImage2D +
