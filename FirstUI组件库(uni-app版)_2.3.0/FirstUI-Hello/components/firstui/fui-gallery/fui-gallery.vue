<template>
  ...
  >
    ...
    >
      ...
      >
        <view
          class="fui-gallery__swiper-item"
          :style="{ height: height + 'px' }"
        >
          <image
            mode="aspectFit"
    ...
    <view class="fui-gallery__index-wrap" :style="{ top: top + 'px' }">
      <text class="fui-gallery__index"
        >{{ active + 1 }}/{{ imgUrls.length }}</text
      >
    </view>
    <view
    ...
    >
      <text
        class="fui-gallery__descr"
        :class="{ 'fui-gallery__text-ellipsis': ellipsis }"
        >{{ descr }}</text
      >
    </view>
  </view>
