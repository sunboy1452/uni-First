<template>
  <view
    class="fui-sticky__wrap"
    :class="{ 'fui-sticky__fixed': !range }"
    :style="getStyles"
    :id="elId"
    ref="fui_sticky__el"
  >
    <view
      :class="{
        'fui-sticky__fixed': range,
        'fui-sticky__fixed-mp': !range && isFixed,
      }"
      :style="getStyle"
    >
      <slot></slot>
    ...
    <view
      class="fui-sticky__seat"
      :class="{ 'fui-sticky__seat-hidden': !isFixed }"
      v-if="!range"
