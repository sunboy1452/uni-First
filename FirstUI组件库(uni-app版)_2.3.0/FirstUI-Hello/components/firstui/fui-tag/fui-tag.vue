<template>
  <view
    class="fui-tag__wrap"
    :class="[
      highlight ? 'fui-tag__opacity' : '',
      originLeft ? 'fui-tag__origin-left' : '',
      originRight ? 'fui-tag__origin-right' : '',
      !background ? `fui-tag__${type}-${theme}` : '',
      (background && !borderColor) || !isBorder ? 'fui-tag__no-border' : '',
    ]"
    :style="{
  ...
  >
    <text
      v-if="text"
      class="fui-tag__text"
      :class="[!background ? `fui-tag_${type}-${theme}` : '']"
      :style="{
        fontSize: size + 'rpx',
        lineHeight: size + 'rpx',
        color: getColor,
...
.fui-tag__success-light {
  ...
  border-color: var(--fui-bg-color-green, rgba(9, 190, 79, 0.05)) !important;
...
.fui-tag__warning-light {
  ...
  border-color: var(--fui-bg-color-yellow, rgba(255, 183, 3, 0.1)) !important;
...
.fui-tag__danger-light {
  background-color: var(--fui-bg-color-red, rgba(255, 43, 43, 0.05)) !important;
  border-color: var(--fui-bg-color-red, rgba(255, 43, 43, 0.05)) !important;
...
.fui-tag__purple-light {
  ...
  border-color: var(--fui-bg-color-purple, rgba(104, 49, 255, 0.05)) !important;
