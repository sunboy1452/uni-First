<template>
  <view class="fui-collapse__item">
    <view
      @tap.stop="onClick(!isOpen)"
      class="fui-collapse-item__title"
      :class="{ 'fui-collapse__disabled': disabled }"
    ...
    >
      ...
      <view
        v-if="arrow"
        :class="{
          'fui-collapse__arrow-close': !isOpen,
          'fui-collapse__arrow-active': isOpen,
          'fui-collapse__item-ani': animation,
        }"
        class="fui-collapse__arrow"
      ...
      <view
        ...
        class="fui-collapse__border"
        :class="{ 'fui-collapse__border-color': !borderColor }"
      ></view>
    </view>
    <view
      class="fui-collapse__content-wrap"
      :class="{ 'fui-collapse-__content-ani': animation }"
      :style="{ height: (isOpen ? height : 0) + 'px', background: contentBg }"
    >
      <view
        :id="elId"
        ref="fui_collapse__el"
        class="fui-collapse__content"
