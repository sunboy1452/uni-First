<template>
  <view class="fui-wrap">
    <view class="fui-banner__box">
      <image
        class="fui-banner"
        :src="`${resUrl}/index/light/img_banner_3x.png`"
        mode="widthFix"
      ></image>
      <view class="fui-banner__content">
        ...
        <view class="fui-desc"
          >First UI是一款轻量、全面可靠的移动端组件库。</view
        >
      </view>
        ...
        >
          <view class="fui-scroll__view fui-align__center">
            <view
              ...
              :key="index"
              class="fui-tab__item fui-flex__center"
              :class="{ 'fui-tab__item-active': tabIndex === index }"
              :id="tab.id"
              @tap="tabClick(index)"
            >
              <view :class="{ 'fui-tab__item-text': tabIndex === index }">{{
                tab.name
              }}</view>
            </view>
          </view>
                  ...
                  <view class="fui-list__item fui-align__center">
                    <view class="fui-item__icon-box">
                      <image
                        ...
                        :src="`${resUrl}/index/light/icon_${item.icon}_3x.png`"
                      ></image>
                    </view>
                    <text>{{ item.name }}</text>
                    <image
