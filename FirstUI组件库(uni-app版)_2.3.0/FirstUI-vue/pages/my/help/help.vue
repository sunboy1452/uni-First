<template>
  <view class="fui-wrap">
    <view class="fui-header">
      <image
        :src="`${resUrl}/help/light/img_banner_3x.png`"
        class="fui-banner"
        mode="widthFix"
      ></image>
    ...
    <view class="fui-page__bd">
      <view class="fui-main__box">
        <view class="fui-search__box fui-align__center" @tap="search">
          <image
            ...
            src="/static/images/help/light/icon_search_3x.png"
            mode="widthFix"
          >
          </image>
        ...
        <view class="fui-menu__box">
          <view class="fui-menu__item" @tap="href(1)">
            <image
              src="/static/images/help/light/icon_introduction_3x.png"
            ></image>
            <text>新手入门</text>
          </view>
          <view class="fui-menu__item" @tap="href(2)">
            <image
              src="/static/images/help/light/icon_introduce_3x.png"
            ></image>
            <text>功能介绍</text>
          </view>
      ...
      <view>
        <fui-list-cell
          arrow
          bottomRight="32"
          v-for="(item, idx) in bugs"
          :key="idx"
          @click="detail(item, idx + 5)"
        >
          <text>{{ item }}</text>
        </fui-list-cell>
      </view>
      <view class="fui-title__box fui-align__center">
        <image
          src="/static/images/help/light/icon_member_relevant_3x.png"
        ></image>
        <text>会员相关</text>
      </view>
      <view>
