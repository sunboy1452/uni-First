    ...
    <view class="fui-page__bd">
      ...
      <fui-timeaxis background="#fff" :padding="['32rpx', '16rpx']">
        <fui-timeaxis-node
          ...
          :lined="index !== processData.length - 1"
        ...
        >
          ...
          <template v-slot:right>
            <view
              ...
              :class="{ 'fui-node__pb': index !== processData.length - 1 }"
            >
              <view
                class="fui-title"
                :style="{ color: index === 3 ? item.activeColor : '#181818' }"
                >{{ item.title }}
              </view>
      ...
      >
        ...
        >
          ...
          <template v-slot:right>
            <view
              class="fui-process__node"
              :class="{ 'fui-node__pbtm': index !== processData.length - 1 }"
            >
              <view
                class="fui-title"
                :style="{ color: index === 3 ? item.activeColor : '#181818' }"
