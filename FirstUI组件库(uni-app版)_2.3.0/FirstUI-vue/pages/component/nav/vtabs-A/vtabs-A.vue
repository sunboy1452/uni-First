<template>
  <view class="fui-wrap">
    ...
    >
      ...
      <fui-vtabs-content
        v-for="(item, index) in vtabs"
        :key="index"
        :tabIndex="index"
      >
        <view
          class="fui-vtabs-content__item"
          :style="{ paddingBottom: vtabs.length - 1 === index ? '800px' : '0' }"
        >
  ...
  onLoad() {
    ...
    const tabs = [
      ...
      },
      {
        ...
        descr:
          "使用 First UI前，请确保你已经学习并熟练使用过 uni-app 或者 微信小程序 。文档详见：https://doc.firstui.cn/docs/started.html。",
      },
      {
        name: "更新日志",
        img: "/cooperate/light/img_banner_3x.png",
        descr:
          "First UI 严格遵循 Semantic Versioning 2.0.0语义化版本规范。更新日志详见：https://doc.firstui.cn/docs/log.html。",
        badge: 1,
      },
      {
        name: "升级指南",
      ...
      },
      {
        ...
        img: "/cooperate/dark/img_banner_3x.png",
        descr:
          "First UI 默认提供了一套主题，并使用 CSS 变量 来实现定制主题，链接中的内容可以帮助你对 CSS 变量 概念有基本的认识，避免许多不必要的困扰。文档详见：https://doc.firstui.cn/docs/theme.html。",
      },
      {
        name: "FAQ",
        img: "/cooperate/light/img_banner_3x.png",
        descr:
          "常见问题解答，使用前请先仔细阅读FAQ内容，了解常见问题，避免在后续使用过程中花费更多时间。详见：https://doc.firstui.cn/docs/FAQ.html。",
      },
    ];
