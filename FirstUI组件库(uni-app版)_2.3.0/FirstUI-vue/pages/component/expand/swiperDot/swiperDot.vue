  ...
  <view class="fui-wrap">
    <view class="fui-page__hd">
      ...
      <view class="fui-page__desc"
        >SwiperDot 轮播图指示点，一般用于banner轮播图。</view
      >
    </view>
    <view class="fui-page__bd">
      ...
      <fui-swiper-dot :styles="styles" :items="items" :current="current2">
        ...
        >
          <swiper-item v-for="(item, index) in items" :key="index">
            <view
              class="fui-banner__cell"
              :class="{ 'fui-item__scale': current2 !== index }"
              :style="{ background: item.background }"
              >First UI 组件库</view
            >
          </swiper-item>
      ...
      items: [
        {
          background: "#09BE4F",
          title:
            "First UI组件库，是基于uni-app开发的一款轻量、全面可靠的跨平台移动端组件库。",
        },
        {
          background: "#FFB703",
