    ...
    <view class="fui-page__bd">
      ...
      <view class="fui-flex__center fui-flex__column">
        <fui-button
          ...
          @click="toggleSelection(tableData[2])"
        ></fui-button>
        <fui-button
          type="gray"
          btn-size="medium"
...
export default {
  ...
  onReady() {
    ...
    this.$refs.tableRef &&
      this.$refs.tableRef.columnColorMethod(this.columnNameColor, "name");
    this.$refs.tableRef &&
      this.$refs.tableRef.columnColorMethod(this.columnCityColor, "city");
  },
  methods: {
    vip() {
