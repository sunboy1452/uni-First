<template>
  <view class="fui-wrap">
    ...
    <view class="fui-page__bd fui-page__spacing">
      ...
      <fui-button :margin="['24rpx']" type="link" color="#465CFF"
        >链接 link</fui-button
      >
      ...
      <fui-button disabled disabledBackground="#F8F8F8" disabledColor="#CCCCCC"
        >禁用按钮
      </fui-button>
      ...
      <fui-button type="warning" :margin="['24rpx']" btn-size="small"
        >small</fui-button
      >
      <fui-button type="danger" btn-size="mini">mini</fui-button>
      <view class="fui-section__title">自定义按钮大小</view>
      <fui-button plain color="#465CFF" borderColor="#465CFF"
        >默认大小</fui-button
      >
      <fui-button
        type="purple"
        ...
        >小型按钮</fui-button
      >
      <fui-button type="danger" width="200rpx" height="72rpx" :size="28"
        >小型按钮</fui-button
      >
      <view class="fui-section__title">自定义颜色</view>
      <fui-button background="#fff" color="#465CFF" borderColor="#465CFF"
        >朴素按钮</fui-button
      >
      <fui-button
        :margin="['24rpx']"
