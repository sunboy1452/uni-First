  ...
  <view class="fui-wrap">
    <view class="fui-page__hd">
      ...
      <view class="fui-page__desc"
        >Collapse 折叠面板，可以折叠/展开的内容区域。</view
      >
    </view>
      ...
      <fui-collapse-item @change="change">
        ...
        <template v-slot:content>
          <view class="fui-descr"
            >First UI
            是一套基于uni-app开发的组件化、可复用、易扩展、低耦合的跨平台移动端UI
            组件库。</view
          >
        </template>
      </fui-collapse-item>
      ...
      <fui-collapse @change="change">
        ...
        >
          ...
          <template v-slot:content>
            <view
              class="fui-descr"
              style="background-color: rgba(255, 183, 3, 0.1)"
              >{{ item.descr }}</view
            >
          </template>
        </fui-collapse-item>
      ...
      list: [
        {
          ...
          answer:
            "可以，组件支持按需引入，详见 First UI 文档 “快速上手”，使用组件前请先仔细阅读组件文档。",
        },
        {
          question:
            "为什么文档或示例中有些组件在GitHub或npm下载的包中无法找到？",
          answer:
            "First UI 分为 “开源版” 和 “商业版”，所有示例或文档中加 “V” 的表示需要开通会员才可获取源码使用，会员内容不会发布到任何公开渠道。",
        },
        {
