    ...
    <view class="fui-page__bd fui-page__spacing">
      ...
      <view class="fui-btn__flex-center">
        ...
        <fui-button
          ...
          text="￥1,020.52"
          :bold="true"
          @click="convertCurrency('￥1,020.52')"
        ></fui-button>
        <fui-button
          type="gray"
          btn-size="medium"
