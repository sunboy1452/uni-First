  ...
  <view class="fui-wrap">
    <view class="fui-page__hd">
      ...
      <view class="fui-page__desc"
        >DropdownMenu 下拉菜单，用于弹出一个下拉菜单给用户选择操作。</view
      >
    </view>
        ...
        <view class="fui-flex__1">
          ...
          >
            <view class="fui-filter__item" @tap="filterTap(1)">
              <text>{{ range }}</text>
              <view
                class="fui-filter__icon"
                :class="{ 'fui-icon__ani': rangeShow }"
              >
