          ...
          <view class="fui-load__item">
            <fui-spin>
              <image
                ...
                class="fui-icon__img fui-circle"
              ></image>
            </fui-spin>
          </view>
        </fui-grid-item>
