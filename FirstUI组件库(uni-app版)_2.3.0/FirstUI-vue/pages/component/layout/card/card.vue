    ...
    <view class="fui-page__bd">
      ...
      <fui-card :src="src" title="标题文字" tag="额外信息">
        <view class="fui-card__content"
          >这是一个基础卡片的示例，此处为自定义内容区域，自行控制内容样式。</view
        >
      </fui-card>
      ...
      <fui-card
        ...
        tag="额外信息"
      >
        <view class="fui-card__content fui-padding"
          >这是一个基础卡片的示例，此处为自定义内容区域，自行控制内容样式。</view
        >
      </fui-card>
      ...
      >
        <view class="fui-list__item">
          ...
          <view class="fui-list__title"
            >First UI重磅上线，一款轻量、全面、可靠的移动端组件库。</view
          >
        </view>
      </fui-card>
      <view class="fui-section__title">推荐布局</view>
      <fui-card>
        <view class="fui-list__item">
          <image
            class="fui-cover"
            :src="`${resUrl}/cooperate/dark/img_banner_3x.png`"
            mode="widthFix"
          ></image>
        </view>
