<template>
  <text
    :class="[
      dot ? 'fui-badge__dot' : 'fui-badge__wrap',
      background ? '' : 'fui-badge__bg-' + type,
      absolute ? 'fui-badge__absolute' : '',
      scaleRatio != 1 && isNvue ? 'fui-badge__trans-origin' : '',
      !background && type === 'white' ? 'fui-badge__text-color' : '',
    ]"
    :style="{
