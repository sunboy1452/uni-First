<template>
  <view
    class="fui-slider__captcha-wrap"
    :class="{ 'fui-sc__wrap-show': isShow }"
  ...
  >
    ...
    <!-- #endif -->
    <view
      class="fui-slider__captcha"
      :style="{ background: background }"
      @tap.stop="stop"
    >
      <text
        class="fui-sc__title"
        :style="{ width: w + 'px', color: color, fontSize: size + 'rpx' }"
        >{{ title }}</text
      >
      <text
        class="fui-sc__descr"
      ...
      <view class="fui-sc__img-box" :style="{ width: w + 'px' }">
        ...
        <view
          ...
          class="fui-sc__slot"
          :class="{
            'fui-sc__slot-circle': circle,
            'fui-sc__slot-bs': !isNvueAndroid,
          }"
        ...
        <view
          class="fui-sc__slot-box"
          ref="imgRef"
          :class="{
            'fui-sc__slot-circle': circle,
            'fui-sc__sb-hidden': !slotSrc,
            'fui-sc__sb-bs': !isNvueAndroid,
          }"
          :style="{ left: x + 'px', top: y + 'px' }"
        >
          <image
            :src="slotSrc"
            class="fui-sc__slot-img"
            :class="{
              'fui-sc__slot-circle': circle && isNvue,
              'fui-sc__img-border': isNvueAndroid,
            }"
          ></image>
        </view>
        <!-- #endif -->
      ...
      <view
        class="fui-sc__sliderbar"
        :style="{ width: w + 'px', height: sliderH + 'px' }"
      >
        <view
          class="fui-sc__bar"
          :style="{
        ...
        <view
          class="fui-sc__slider"
          :class="{ 'fui-sc__slider-bg': !getSliderBgColor }"
          :style="{
            width: sliderH * 2 + 'px',
            height: sliderH + 'px',
            borderRadius: sliderH + 'px',
        ...
        <view
          class="fui-sc__slider"
          :class="{
            'fui-sc__slider-bg': !getSliderBgColor,
            'fui-sc__reset-ani': resetAni,
          }"
          :style="{
            width: sliderH * 2 + 'px',
...
export default {
  ...
  methods: {
    ...
    // #ifdef APP-NVUE
    getClipImg(imgUrl) {
      let f_dst = `_documents/${Math.ceil(Math.random() * 10e5).toString(
        36
      )}.jpg`;
