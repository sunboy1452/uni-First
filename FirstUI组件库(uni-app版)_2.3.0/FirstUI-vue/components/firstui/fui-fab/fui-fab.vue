<template>
  <view @touchmove.stop.prevent="stop">
    ...
    <view
      ...
      :class="[
        position === 'left' ? 'fui-fab__wrap-left' : 'fui-fab__wrap-right',
      ]"
      :style="getStyles"
    >
      <view
      ...
      >
        ...
        >
          ...
          <!-- #ifndef H5 -->
          <button
            class="fui-fab__opentype-btn"
            :open-type="btn.openType"
            :app-parameter="btn.appParameter"
            :lang="btn.lang"
            :sessionFrom="btn.sessionFrom"
            :sendMessageTitle="btn.sendMessageTitle"
            :sendMessagePath="btn.sendMessagePath"
            :sendMessageImg="btn.sendMessageImg"
            :showMessageCard="btn.showMessageCard"
            @contact="bindcontact"
      ...
      >
        <view
          class="fui-fab__btn-inner"
          :class="{ 'fui-fab__btn-ani': isShow }"
          ref="fui_fm_ani"
        >
          <slot>
