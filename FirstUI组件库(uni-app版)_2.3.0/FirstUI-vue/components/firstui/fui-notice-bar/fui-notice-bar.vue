<template>
  ...
  >
    ...
    <view
      class="fui-notice__wrap"
      :class="{ 'fui-notice__wrap-scroll': scrollable }"
    ...
    >
      <view
        :id="elId_box"
        :class="{
          'fui-notice__content': scrollable,
          'fui-notice__content-single': !scrollable && single,
        }"
      >
        <text
          ref="animationEle"
          class="fui-notice__text"
          :id="elId"
          :style="{
            color: getColor,
            fontSize: size + 'rpx',
          ...
          :class="{
            'fui-notice__single': !scrollable && single,
            'fui-notice__scrollable': scrollable,
            'fui-notice__text-color': !color && !isNvue,
          }"
          >{{ content }}</text
        >
      </view>
              ...
              if (!this.stopAnimation) {
                animation.transition(
                  this.$refs["animationEle"],
                  {
                    ...
                    timingFunction: "linear",
                    duration:
                      ((this.noticeWidth - winWidth) / Number(this.speed)) *
                      1000,
                    delay: 1000,
                  },
                  () => {
