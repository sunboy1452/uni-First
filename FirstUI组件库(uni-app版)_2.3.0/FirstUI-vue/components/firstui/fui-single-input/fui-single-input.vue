<template>
  ...
  >
    ...
    >
      <view
        ...
        :style="{
          ...
          borderColor:
            activeIndex === index || inputVal[index]
              ? getActiveColor
              : borderColor,
          ...
          borderBottomWidth:
            (border == 1 || border == 2 ? borderWidth : 0) + 'rpx',
        }"
        @tap="onTap"
      ...
      >
        <text
          class="fui-sinput__text"
          :class="{ 'fui-sinput__color': !color }"
          :style="{
            width: width + 'rpx',
            height: height + 'rpx',
            fontSize: size + 'rpx',
        ...
        <text
          ...
          :style="{ fontSize: size + 'rpx', fontWeight: fontWeight }"
          >{{
            password ? (inputVal[index] ? "●" : "") : inputVal[index] || ""
          }}</text
        >
        <view
          class="fui-sinput__cursor"
          :class="{
            'fui-sinput__cursor-color': !cursorColor,
            'fui-sinput__cursor-ani': activeIndex === index && focus,
          }"
          :ref="item"
    ...
    <input
      ...
      :password="password"
      :type="type"
      class="fui-sinput__hidden"
      :class="{ 'fui-sinput__alizero': aliZero }"
      @input="onInput"
      @blur="onBlur"
      :maxlength="length"
      v-if="native"
