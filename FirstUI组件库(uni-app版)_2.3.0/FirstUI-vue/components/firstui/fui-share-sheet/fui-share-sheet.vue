<template>
  <view @touchend="stop">
    <view
      class="fui-share__sheet-mask"
      :style="getStyle"
      :class="{ 'fui-ss__mask-show': show }"
      ref="fui_ssm_ani"
      @tap.stop="maskClick"
    >
    </view>
    <view
      class="fui-share__sheet-wrap"
      :class="{
        'fui-share__sheet-radius': radius,
        'fui-share__sheet-show': show,
        'fui-share__sheet-hidden': nvueHidden,
      }"
    ...
    >
      <slot>
        <text
          class="fui-share__sheet-title"
          :style="{ fontSize: size + 'rpx', color: color }"
          >{{ !title || title === "true" || title === true ? "" : title }}</text
        >
      </slot>
      <view
        class="fui-share__sheet-box"
      ...
      >
        <scroll-view
          ...
          :scroll-x="true"
          class="fui-share__sheet-scroll"
        >
          <view
            class="fui-share__sheet-list"
            :class="{ 'fui-share__sheet-full': isFull }"
            :style="{
          ...
          >
            ...
            >
              ...
              <!-- #ifndef APP-NVUE -->
              <button
                class="fui-sharesheet__btn"
                :open-type="obj.openType"
                :app-parameter="obj.appParameter"
      ...
      <view
        class="fui-share__sheet-button"
        :class="{ 'fui-ss__safe-weex': iphoneX && safeArea }"
        :style="{ background: btnBackground }"
      >
        <text
          class="fui-share__sheet-btn"
          :class="{ 'fui-ss__safe-weex': iphoneX && safeArea }"
