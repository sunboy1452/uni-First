<template>
  ...
  >
    ...
    <!-- #ifndef APP-NVUE -->
    <view
      class="fui-switch__input-def"
      :style="{
        background: val ? color : '#dfdfdf',
        borderColor: val ? color : borderColor,
      }"
      :class="{
        'fui-switch__input--checked': val,
        'fui-checkbox__disabled': disabled,
        'fui-switch__color': val && !color,
      }"
      v-if="type === 'switch'"
    >
      <view
        class="fui-switch__input-after"
        :style="{ background: val ? (btnColor ? btnColor : '#fff') : '#fff' }"
        :class="{ 'fui-switch__input--after': val }"
      >
        <slot></slot>
      </view>
      <switch
        class="fui-switch__hidden"
        :class="{ 'fui-pointer__events': isLabel }"
        @change="change"
        :name="name"
        :checked="val"
        :disabled="disabled"
    ...
    <!-- #endif -->
    <view
      class="fui-checkbox__self"
      :class="{
        'fui-checkbox__disabled': disabled,
        'fui-switch__color': !getColor && val,
      }"
      :style="{
        background: val ? getColor : '#fff',
