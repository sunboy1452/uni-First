  ...
  data() {
    return {
      ...
      answerList: {
        ...
        2: [
          "First UI 分为 “开源版” 和 “商业版”，所有示例或文档中加 “V” 的表示需要开通相应版本会员才可获取源码使用，会员内容不会发布到任何公开渠道。",
        ],
        3: [
        ...
        13: [
          "开通以及查看会员价格请前往 First UI官网 （firstui.cn)，随着功能的增加与完善，会员价格会相应调整。",
          "在官网购买开通会员后，个人中心订单页即可下载会员源码",
        ],
