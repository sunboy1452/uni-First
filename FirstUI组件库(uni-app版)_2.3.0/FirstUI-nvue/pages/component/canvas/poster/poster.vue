    ...
    return {
      ...
      basicData: {
        ...
        imgs: [
          {
            imgResource:
              "https://res.firstui.cn/static/images/common/img_logo.png",
            x: 20,
            y: 260,
            width: 100,
            height: 100,
      ...
      goodsData: {
        ...
        imgs: [
          {
            imgResource:
              "https://res.firstui.cn/static/images/component/img_bg_poster.png",
            x: 0,
            y: 0,
            width: 560,
            height: 800,
          ...
          {
            imgResource:
              "https://res.firstui.cn/static/images/component/img_goods_3x.jpg",
            x: 56,
            y: 128,
            width: 448,
            height: 448,
          ...
          {
            imgResource:
              "https://res.firstui.cn/static/images/qrcode/wx_qrcode.jpg",
            x: 378,
            y: 822,
            width: 136,
            height: 136,
    ...
    poster(type) {
      if (this.isReady) {
        ...
        if (this.showFilePath) {
          ...
          this.$refs.generator.generatePoster(
            type === 1 ? this.basicData : this.goodsData,
            (res) => {
              //海报图片res
              console.log(res);
