<template>
  <scroll-view
    ...
    :class="{
      'fui-tabs__fixed': isFixed && !isSticky,
      'fui-tabs__sticky': isSticky,
    }"
    ...
    <view class="fui-scroll__view" :class="{ 'fui-tabs__full': !alignLeft }">
      ...
      >
        <view
          ...
          :class="{
            'fui-tabs__wrap-disabled': tab.disabled,
            'fui-tabs__item-column': direction === 'column' && tab.icon,
          }"
          :style="{ height: height + 'rpx' }"
        >
          <view
            class="fui-tabs__line-wrap"
            :class="{ 'fui-tabs__line-center': center }"
            :style="{
              bottom: bottom + 'rpx',
              left: `-${padding}rpx`,
              right: `-${padding}rpx`,
          ...
          >
            <view
              class="fui-tabs__ac-line"
              :class="{
                'fui-tabs__line-short': short,
                'fui-tabs__full': !short,
                'fui-tabs__slider-color': !getSliderBgColor,
              }"
              :style="{
          ...
          <image
            ...
            :class="{ 'fui-tabs__icon-column': direction === 'column' }"
            :src="
              tabIndex === index && tab.selectedIcon
                ? tab.selectedIcon
                : tab.icon
            "
            v-if="tab.icon"
          ...
          <view class="fui-tabs__text">
            <text
              :style="{
                fontSize: selectedSize + 'rpx',
                fontWeight:
                  tabIndex === index ? selectedFontWeight : fontWeight,
                height: height + 'rpx',
            ...
            >
            <text
              class="fui-tabs__text-nvue"
              :class="{
                'fui-tabs__selected-color':
                  !getSelectedColor && tabIndex === index,
                'fui-tabs__text-color': !color && tabIndex !== index,
              }"
              :style="{
                fontSize:
                  (tabIndex === index && isNvue ? selectedSize : size) + 'rpx',
            ...
            <text
              :class="{
                'fui-tabs__badge-color': !getBadgeBgColor,
                'fui-tabs__badge-dot': isDot,
                'fui-tabs__badge': !isDot,
              }"
              :style="{
                color: badgeColor,
