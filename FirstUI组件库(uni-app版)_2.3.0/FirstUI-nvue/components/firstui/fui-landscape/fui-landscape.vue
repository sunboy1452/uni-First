<template>
  <view
    class="fui-landscape__wrap"
    :class="{
      'fui-landscape__fixed': !absolute,
      'fui-landscape__absolute': absolute,
      'fui-landscape__show': isShow,
    }"
  ...
  >
    <view class="fui-landscape__inner">
      <slot></slot>
      <view
        class="fui-landscape__icon"
        :class="{
          'fui-landscape__icon-rt': position == 2,
          'fui-landscape__icon-def': position == 3,
        }"
        :style="getStyles"
        v-if="closable"
      >
