<template>
  <view
    ...
    :class="{
      'fui-textarea__flex-start': flexStart,
      'fui-textarea__border-nvue': textareaBorder,
    }"
    :style="{
  ...
  >
    ...
    <!-- #ifndef APP-NVUE -->
    <view
      class="fui-textarea__border"
      :class="{ 'fui-textarea__bordercolor': !borderColor }"
      :style="{ borderRadius: getRadius, borderColor: borderColor }"
      v-if="textareaBorder"
    ></view>
    <!-- #endif -->
    <!-- #ifdef APP-NVUE -->
    <view class="fui-textarea__required" v-if="required && !flexStart">
      <text
        ...
        :style="{ color: getRequiredColor, paddingTop: '2rpx' }"
        >*</text
      >
    </view>
    <text
      class="fui-textarea__required"
      :style="{ color: getRequiredColor, top: requiredTop }"
    ...
    <view
      ...
      :style="{ color: getRequiredColor, top: flexStart ? requiredTop : '50%' }"
      v-if="required"
      >*</view
    >
    <!-- #endif -->
    ...
    <view class="fui-textarea__flex-1">
      <textarea
        ...
        :class="{
          'fui-text__right': textRight,
          'fui-textarea__disabled-styl': disabled && disabledStyle,
        }"
        :style="{
          height: height,
          minHeight: minHeight,
