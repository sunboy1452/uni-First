<template>
  <view class="fui-charts__pie-wrap">
    ...
    >
      <view
        class="fui-charts__pie-inner"
        :style="{
          width: radius * 2 + 'px',
          height: radius * 2 + 'px',
          background: item.angle > 180 ? item.color : 'transparent',
          zIndex: item.angle > 180 ? 10 : 'auto',
          clip:
            item.transformAngle > 180
              ? `rect(0, ${radius}px, ${radius * 2}px, 0)`
              : 'auto',
        }"
