<template>
  <view
    class="fui-list__cell"
    :class="{
      'fui-highlight': highlight,
      'fui-list__cell-background': !background,
    }"
    :style="{
      paddingTop: getPadding[0] || 0,
      paddingRight: getPadding[1] || 0,
      paddingBottom: getPadding[2] || getPadding[0] || 0,
      paddingLeft: getPadding[3] || getPadding[1] || 0,
  ...
  >
    <view
      ...
      class="fui-cell__border-top"
      :class="{ 'fui-cell__border-color': !getBorderColor }"
    ></view>
    <slot></slot>
    <view
      v-if="bottomBorder"
      :style="{
        background: getBorderColor,
        left: getBottomLeft + 'rpx',
        right: bottomRight + 'rpx',
      }"
      class="fui-cell__border-bottom"
      :class="{ 'fui-cell__border-color': !getBorderColor }"
    ></view>
    <view
