<template>
  <view class="fui-dropdown__menu" ref="fui_dm_wrap" @tap="resetCalc">
    ...
    <view
      class="fui-dropdown__menu-list"
      :class="{
        'fui-ddm__down': direction !== 'up',
        'fui-ddm__up': direction === 'up',
        'fui-ddm__down-show': isShow && direction !== 'up',
        'fui-ddm__up-show': isShow && direction === 'up',
      }"
      :style="getStyles"
        ...
        <view>
          <view
            ...
            :style="{
              ...
              padding: padding,
              borderBottomColor:
                splitLine && isNvue ? lineColor : 'transparent',
            }"
            :class="{
              'fui-ddm__reverse': isReverse,
              'fui-ddm__item-line': splitLine && itemList.length - 1 !== index,
            }"
          ...
          >
            <view
              class="fui-ddm__checkbox"
              :class="{
                'fui-is__checkmark': isCheckMark,
              ...
              :style="{
                background:
                  model.checked && !isCheckMark ? getChkColor : 'transparent',
                borderColor:
                  model.checked && !isCheckMark ? getChkColor : borderColor,
              }"
              v-if="isCheckbox"
            >
              <view
            ...
            <view class="fui-ddm__flex">
              <view
                class="fui-ddm__icon-box"
                :class="{
                  'fui-ddm__icon-ml': !isReverse && isCheckbox,
                  'fui-ddm__icon-mr': isReverse,
                }"
              ...
              <text
                ...
                :class="{
                  'fui-ddm__text-pl': !isReverse && (isCheckbox || model.src),
                  'fui-ddm__text-pr': isReverse && (isCheckbox || model.src),
                }"
                :style="{
                  fontSize: size + 'rpx',
...
export default {
  ...
  computed: {
    getStyles() {
      ...
      styles += `left:${this.n_left + left}px;top:${this.n_top}px;height:${
        this.maxHeight
      }rpx;`;
