<template>
  <view
    class="fui-wing__blank-wrap"
    :class="[
      radius ? 'fui-wing__blank-hidden' : '',
      getPadding ? '' : `fui-wing__blank-${getSize}`,
    ]"
    :style="getStyles"
    @tap="handleClick"
  >
  ...
  computed: {
    ...
    getStyles() {
      ...
      let styles = `background:${
        this.background || (app && app.background) || "transparent"
      };border-radius:${this.radius}rpx;margin-top:${
        this.marginTop
      }rpx;margin-bottom:${this.marginBottom}rpx;`;
